...
It's configured to fetch my latest layout from Oryx, and merge whatever advanced customizations I want, like Achordion and Repeat Key. It also automates building the firmware, and even drawing that cool SVG above.
